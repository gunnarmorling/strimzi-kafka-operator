...
[[kind-Topic]]
[[type-Topic]]
### `Topic` kind v1alpha1 kafka.strimzi.io
...
|additionalProperties  1.2+<.<|
|map
|topicName             1.2+<.<|The name of the topic. It is recommended to not set this, and for kafka topic names to be compatible Kubernetes resource names.When absent this will default to the metadata.name of the topic. 
|string
|====
