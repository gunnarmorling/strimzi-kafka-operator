...
include::con_topic-operator.adoc[leveloffset=+2]
...
include::proc_creating-a-topic.adoc[leveloffset=+2]

include::proc_changing-a-topic.adoc[leveloffset=+2]

include::proc_deleting-a-topic.adoc[leveloffset=+2]

include::ref_topic-operator-environment.adoc[leveloffset=+2]
